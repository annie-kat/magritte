...
//Last modified: Wed, Apr 23, 2014 08:11:11 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -14.720406254337632 26.62913968438021 81.894144240820594 ;
	setAttr ".r" -type "double3" -12.600000000000078 -9.9999999999976961 -2.0185124150723885e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 86.863392805115737;
...
createNode transform -n "canvas";
	setAttr ".t" -type "double3" 0 12.689443597583017 0.55524318535555961 ;
...
createNode transform -n "polySurface5" -p "easel1";
	setAttr ".t" -type "double3" 0 1.6747388747821392 0 ;
