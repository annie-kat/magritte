...
//Name: the_human_condition_1.ma
//Last modified: Wed, Apr 23, 2014 08:00:48 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.1237365290670891e-15 32.141316886708047 22.871411140724916 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 34.592850639179048;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.023303688491949526 9.817430266253643 100.1 ;
...
createNode transform -n "canvas";
	setAttr ".t" -type "double3" 0 11.014704722800873 0.55524318535555961 ;
...
createNode mesh -n "easelShape1" -p "easel1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.23275082168347394 0.66618795015595178 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode file -n "file1";
	setAttr ".ftn" -type "string" "/Users/alvarogil/Dropbox/SeniorProject/Models/Inside/The Human Condition #1/floor_wood_diffuse.jpg";
...
createNode polyPlanarProj -n "polyPlanarProj1";
	...
	setAttr ".ps" -type "double2" 4.9986740350723267 15.380393028259277 ;
...
createNode polyPlanarProj -n "polyPlanarProj2";
	...
	setAttr ".ws" yes;
	setAttr ".pc" -type "double3" 0.00012969970703125 7.6804776191711426 -1.5894281268119812 ;
	setAttr ".ps" -type "double2" 7.497291088104248 15.380393028259277 ;
...
connectAttr "polyTweakUV2.out" "easelShape1.i";
...
connectAttr "easelShape1.iog" "lambert2SG.dsm" -na;
...
// End of the_human_condition_1.ma
